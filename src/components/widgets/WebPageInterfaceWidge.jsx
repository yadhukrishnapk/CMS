    ...
    >
      <div className="flex flex-col lg:flex-row items-center h-full">
        ...
        <div className="flex-1 p-8 lg:p-16 space-y-6">
          {/* Subtitle */}
          <div
            className={`text-sm font-semibold text-green-600 tracking-wider uppercase ${
              widget.props.subtitle ? "" : "empty-placeholder"
            }`}
            contentEditable={isEditable}
            suppressContentEditableWarning={true}
            onInput={(e) =>
              handleContentChange(e, "html", () =>
                handleContentUpdate("subtitle", e.target.innerHTML)
              )
            }
            onFocus={handleFocus}
            onBlur={handleBlur}
            ...
            dangerouslySetInnerHTML={
              isEditable ? undefined : { __html: subtitle }
            }
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button
              ...
              onClick={() =>
                isEditable && console.log("Primary button clicked")
              }
            >
              <span
                contentEditable={isEditable}
            ...
            <button
              ...
              onClick={() =>
                isEditable && console.log("Secondary button clicked")
              }
            >
              <span
                contentEditable={isEditable}
                ...
                className={`outline-none ${
                  widget.props.secondaryButtonText ? "" : "empty-placeholder"
                }`}
                data-placeholder="Enter button text..."
              >
